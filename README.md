...
- 🔘 **Widget tiện lợi (FAB):** Nút công cụ nổi ngay trên trang X.com giúp bạn thao tác nhanh mà không cần mở popup.
...
- `storage`: Lưu cấu hình cài đặt của bạn (options).
...
*Phát triển nội bộ — Phiên bản 3.0.0*
