...
> **Phiên bản hiện tại: 6.1.5** — hỗ trợ tải ảnh/video trực tiếp trên Telegram Web A/K với xử lý an toàn cho URL `blob:`, `data:` và HTTP(S).
...
*Phát triển nội bộ — Phiên bản **6.1.5** | Cập nhật: 2026-09-17*
