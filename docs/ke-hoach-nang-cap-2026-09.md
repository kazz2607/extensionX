...
> Phạm vi: ExtensionX v6.1.3 (Manifest V3)
...
| **v6.1.3** (Telegram Reliability) | Pha 6 | Sửa luồng `blob:`/`data:`, giữ đúng định dạng file, xác thực sender và bổ sung regression tests. | ✅ **Đã hoàn thành** |
