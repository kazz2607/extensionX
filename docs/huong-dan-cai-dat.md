...
> **Phiên bản hiện tại:** 6.1.3 | Cập nhật: 2026-09-17

Từ v6.1.3, tiện ích còn hỗ trợ tải trực tiếp ảnh/video trên `https://web.telegram.org` bằng nút tải xuất hiện trên media của giao diện A/K.
...
*Phiên bản: 6.1.3 | Cập nhật: 2026-09-17*
