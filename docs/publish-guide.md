...
4. Đặt tên file ZIP rõ ràng: `x-media-downloader-v6.1.3.zip`
...
2. Kéo thả file `x-media-downloader-v6.1.3.zip` của bạn vào ô tải lên.
...
🎉 **Chúc bạn phát hành X Media Downloader v6.1.3 thành công!**
