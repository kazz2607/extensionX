...
4. Đặt tên file ZIP rõ ràng: `x-media-downloader-v6.1.4.zip`
...
2. Kéo thả file `x-media-downloader-v6.1.4.zip` của bạn vào ô tải lên.
...
🎉 **Chúc bạn phát hành X Media Downloader v6.1.4 thành công!**
