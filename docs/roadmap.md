...
[content.js] Lắng nghe CustomEvent
        ...
        │
        ▼
[service-worker.js] Nhận message, lưu vào chrome.storage.session
...
### ✅ Phase 3 — Hoàn Thiện (v3.0.0 → v3.6.0)
...
## 3. Tính Năng Còn Lại / Kế Hoạch Tiếp Theo
...
### ✅ Download Mini Button cho từng Tweet (v3.6.0)
