...
> Cập nhật: 2026-09-17 | Phiên bản hiện tại: **6.1.6**

---

## 1. Kiến Trúc Hiện Tại (v6.1.6)
...
├── src/
│   ├── manifest.json              # Chrome Extension Manifest V3 (version 6.1.6)
│   ├── background/
...
- **v6.1.6** Telegram Reliability: xử lý `blob:`/`data:` trong tab nguồn, giữ đúng định dạng file, xác thực sender và bổ sung regression tests.
...
| v6.1.6 | **Telegram Reliability** — Sửa tải `blob:`/`data:`, phần mở rộng file, phản hồi UI và xác thực nguồn message |
...
v6.1.6  ── Telegram Media Download Reliability                                            ✅ DONE
