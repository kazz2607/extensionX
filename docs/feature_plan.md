...
Dựa trên phiên bản hiện tại (v5.5.4) đã hoạt động rất ổn định với các tính năng cơ bản và phím tắt thông minh, dưới đây là một số ý tưởng tính năng mở rộng nâng cao mà chúng ta có thể cân nhắc phát triển tiếp theo để biến ExtensionX thành một công cụ siêu mạnh mẽ:
